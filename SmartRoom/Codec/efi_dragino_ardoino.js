function Decode(fPort, bytes, variables) {
    ...
    if (fPort === 1) {
      ...
      decoded.out_door = bytes[i++] | (bytes[i++] << 8);
      decoded.in_doortemp  = bytes[i++] | (bytes[i++] << 8);
      decoded.humidity = bytes[i++] | (bytes[i++] << 8);
      decoded.windspeed = bytes[i++] | (bytes[i++] << 8);
      decoded.winddirection = bytes[i++] | (bytes[i++] << 8);
      decoded.uv = bytes[i++] | (bytes[i++] << 8);
      decoded.lux = bytes[i++] | (bytes[i++] << 8);
